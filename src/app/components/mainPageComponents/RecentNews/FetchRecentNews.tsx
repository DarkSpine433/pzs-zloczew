  ...
  return (
    <>
      {data.docs.map((doc: any, index) => (
        <Dialog key={index}>
          <DialogTrigger>
            <div className=" w-full max-w-96  h-fit min-h-96  relative bg-secondary p-2 rounded-lg shadow-md shadow-blue-300 hover:-translate-y-1 hover:shadow-md hover:shadow-primary transition-all gap-2 ">
