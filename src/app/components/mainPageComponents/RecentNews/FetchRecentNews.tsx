          ...
          <Card className="transition-all hover:shadow-md hover:-translate-y-1 hover:[&>img]:scale-105 group overflow-hidden  ">
            <div className="w-full h-full overflow-hidden   ">
              <Image
                ...
                width={300}
                height={300}
                className="rounded-lg w-96 h-64 object-cover overflow-hidden aspect-square transition-all"
              />
            </div>

            <CardContent className="mt-5">
              <CardTitle>
                <h2 className="text-[1.08rem] font-bold pb-5 group-hover:text-primary transition-all">
                  {doc.title}
                </h2>
              </CardTitle>
              <CardDescription>
