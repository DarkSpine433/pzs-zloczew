  ...
  return (
    <>
      <div
        ...
        className={`after:to-gray-black/50 overflow-hidden-500 relative z-10 block bg-cover bg-center bg-no-repeat py-12 shadow-lg after:absolute after:inset-0 after:left-0 after:top-0 after:z-[-5] after:block after:h-full after:w-full after:bg-foreground/70 after:bg-gradient-to-b after:from-foreground after:content-['']`}
      >
        <h1
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-10 rounded border-x px-3 pb-10 pt-10 sm:px-10">
