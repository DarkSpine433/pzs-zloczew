...
export interface Config {
  ...
  globals: {
    ...
    offer: Offer;
    contact: Contact;
    schooljournal: Schooljournal;
  };
  globalsSelect: {
    header: HeaderSelect<false> | HeaderSelect<true>;
    offer: OfferSelect<false> | OfferSelect<true>;
    contact: ContactSelect<false> | ContactSelect<true>;
    schooljournal: SchooljournalSelect<false> | SchooljournalSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "schooljournal".
 */
export interface Schooljournal {
  id: string;
  link?: string | null;
  updatedAt?: string | null;
  createdAt?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "schooljournal_select".
 */
export interface SchooljournalSelect<T extends boolean = true> {
  link?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
